...
tables1<- function(x,per,g,v){
  ...
  t02 <- t01[,lapply(.SD,round,2),
             .SDcols=c("CEPA1", "CEPA2", "CEPA3", "CEPA4", "CEPA5", "CEPA6", "CEPA7-9",
                       ...
                       "CREMA12_15_16", "TOT_CEPA","TOT_CREMA","TOTAL")]
  ...
  t21 <- t20[,.(NACE = nace_r2, CEPA1, CEPA2, CEPA3, CEPA4, CEPA5, CEPA6, `CEPA7-9`, TOT_CEPA, S1_9,
                CREMA10, CREMA11, CREMA13A, CREMA13B, CREMA13C, CREMA14, CREMA12_15_16, TOT_CREMA, S10_16,
                TOTAL, STotC, S1_16)]
  ...
  diff <- data.table(NACE="DIFF",round(t22[22,2:22]-t22[23,2:22],2),D1_9=NA,D10_16=NA,DTotC=NA,D1_16=NA)
  t23 <- rbind(t22,diff)
  ...
  colnames(t23) <- c("NACE","CEPA1", "CEPA2", "CEPA3", "CEPA4", "CEPA5", "CEPA6", "CEP79","TOTCEP",
                     "CRE10", "CRE11", "CRE13A", "CRE13B", "CRE13C", "CRE14", "CRE16","TOTCRE","TOTAL",
                     "DTotC", "D1_9","D10_16","D1_16")
